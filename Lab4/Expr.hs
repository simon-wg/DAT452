...
simplify (Add (Cos e1) e2) = Add (Cos (simplify e1)) (simplify e2)
simplify (Add e1 (Cos e2)) = Add (simplify e1) (Cos (simplify e2))
simplify (Add (Sin e1) e2) = Add (Sin (simplify e1)) (simplify e2) 
simplify (Add e1 (Sin e2)) = Add (simplify e1) (Sin $ simplify e2) 
...
simplify (Mul (Cos e1) e2) = Mul (Cos (simplify e1)) (simplify e2)
simplify (Mul e1 (Cos e2)) = Mul (simplify e1) (Cos (simplify e2))
simplify (Mul (Sin e1) e2) = Mul (Sin (simplify e1)) (simplify e2) 
simplify (Mul e1 (Sin e2)) = Mul (simplify e1) (Sin $ simplify e2) 
